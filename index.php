        ...
        function quidSubmitTip(res) {
            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    let target = document.getElementById(res.productID);
                    if (xhttp.responseText !== 'error') {
                        target.nextElementSibling.style.display = 'none';
                        target.getElementsByTagName('button')[0].getElementsByClassName('quid-pay-button-price')[0].innerHTML = _quid_wp_global[res.productID].paidText;
                    } else {
            ...
            xhttp.send(JSON.stringify({paymentResponse: res}));
        }
...
add_shortcode('quidTip', 'quidSlider');
...
function quidSlider($atts) {
    ...
    <div
        ...
        quid-product-description="'.$atts["description"].'"
        quid-text="'.$atts["text"].'"
        quid-text-paid="'.$atts["paid"].'"
    ></div>
    <div class="wp-quid-error" style="display: none;">
        <img class="wp-quid-error-image" src="data:image/png;base64," />
        Payment validation failed
    </div>
    <script>
        let baseElement = document.getElementById("'.$atts["id"].'");
