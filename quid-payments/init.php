...
namespace QUIDPaymentsInit {
    ...
    class Init {
        ...
        public function addScripts() {
            ...
            wp_register_script( 'js_quid_client', 'https://js.qubit.sh/v1/client.js?quid-plugin='.$quidPluginVersion );
            ...
            wp_register_style( 'css_quid_client', 'https://js.qubit.sh/v1/assets/quid.css?quid-plugin='.$quidPluginVersion );
